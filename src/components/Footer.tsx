...
const Footer = () => {
  return (
    <footer className="relative bg-[#050505] pt-8 md:pt-32 pb-10 border-t border-white/5 overflow-hidden" id="contact">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-20 mb-8 md:mb-32">
          ...
          <ScrollReveal>
            ...
            <p className="text-base md:text-xl text-gray-400 mb-6 md:mb-12 max-w-md leading-relaxed">
            ...
            <div className="flex flex-col space-y-5 md:space-y-10">
              ...
              <div>
                ...
                <p className="text-base md:text-xl font-display font-medium text-white leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-10 sm:gap-16">
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-2">
                    <a href="tel:+212539324232" className="text-base md:text-xl font-display font-medium text-white hover:text-[#4DA8C8] transition-colors">
                      <span className="text-gray-500 text-sm mr-2 font-normal">Fixe:</span> +212 539 32 42 32
                    </a>
                    <a href="tel:+212654179010" className="text-base md:text-xl font-display font-medium text-white hover:text-[#4DA8C8] transition-colors">
                      <span className="text-gray-500 text-sm mr-2 font-normal">Mobile:</span> +212 654 17 90 10
                    </a>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-2">
                    <a href="mailto:contact@conceptify.pro" className="text-base md:text-xl font-display font-medium text-white hover:text-[#8E2A8B] transition-colors">
                      contact@conceptify.pro
                    </a>
                    <a href="mailto:salaheddineous@gmail.com" className="text-base md:text-xl font-display font-medium text-white hover:text-[#8E2A8B] transition-colors">
